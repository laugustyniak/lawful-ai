...
- **EU AI Act / EU legislative radar:** EUR-Lex Atom endpoint returned no readable payload in this run, so no reliable fresh OJ extraction from the feed right now.
